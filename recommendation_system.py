...
def runRecommendationSystem():
    ...
    inputFile = open(str(os.path.realpath(os.path.join(os.path.dirname(__file__),  'db.json'))), encoding = 'utf-8')
    inputData = json.load(inputFile)
    inputFile.close()

    # leitura do arquivo de config
    inputFile2 = open(str(os.path.realpath(os.path.join(os.path.dirname(__file__),  'config.json'))), encoding = 'utf-8')
    inputConfig = json.load(inputFile2)
    inputFile2.close()

    # leitura do arquivo de foods
    inputFile3 = open(str(os.path.realpath(os.path.join(os.path.dirname(__file__),  'foods.json'))), encoding = 'utf-8')
    inputFoods = json.load(inputFile3)
    inputFile3.close()


    # leitura do arquivo de grouping
    inputFile4 = open(str(os.path.realpath(os.path.join(os.path.dirname(__file__),  'grouping.json'))), encoding = 'utf-8')
...
#     # resultFile = open("output/outputFile-meal-1.json", encoding = 'utf-8')
